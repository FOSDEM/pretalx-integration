...
* devroom-settings:
  * main module which contains customizations to link manager teams and review teams to tracks, and store other settings relevant for devrooms.
* nanoc-export:
  * the export used by nanoc for building the website is part of this repository.
